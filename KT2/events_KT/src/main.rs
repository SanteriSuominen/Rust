fn main() {
    let flight_accident_events= [
        ...
        (2026_01_17, "Indonesia Air Transport ATR 42 crashed near Mount Bulusaraung in South Sulawesi"),
        (1995_01_19, "Bristow Helicopters Flight 56C was struck by lightning while carrying oil workers from Aberdeen"),
        (2006_01_19, "A Slovak Air Force Antonov An-24 crashes near Hejce, Hungary"),
        (1960_01_19, "Scandinavian Airlines System Flight 871 crashes near Ankara Esenboğa Airport in Turkey"),
