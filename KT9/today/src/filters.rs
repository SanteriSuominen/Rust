...
mod tests {
    ...
    fn accepts_all_events_when_no_criteria() {
        ...
        let event = make_event("2026-03-25", "Rust lecture", Category::from_primary("school"));
    ...
    fn filters_by_month_day() {
        let filter = EventFilter::builder()
            ...
            .build();
        let accepted = make_event("2026-03-25", "Rust lecture", Category::from_primary("school"));
        let rejected = make_event("2026-03-26", "Rust lecture", Category::from_primary("school"));
    ...
    fn filters_by_category() {
        let filter = EventFilter::builder()
            ...
            .build();
        let accepted = make_event("2026-03-25", "Independence Day", Category::from_primary("holiday"));
    ...
    fn filters_by_text_in_description() {
        ...
        let accepted = make_event("2026-03-25", "Rust workshop", Category::from_primary("school"));
        let rejected = make_event("2026-03-25", "Math workshop", Category::from_primary("school"));
    ...
    fn filters_by_month_day_and_category() {
        let filter = EventFilter::builder()
            ...
            .build();
        let accepted = make_event("2026-03-25", "Rust workshop", Category::from_primary("school"));
        let wrong_day = make_event("2026-03-26", "Rust workshop", Category::from_primary("school"));
        let wrong_category = make_event("2026-03-25", "Rust workshop", Category::from_primary("work"));
    ...
    fn filters_by_month_day_and_text() {
        ...
        let accepted = make_event("2026-03-25", "Rust workshop", Category::from_primary("school"));
        let wrong_day = make_event("2026-03-26", "Rust workshop", Category::from_primary("school"));
        let wrong_text = make_event("2026-03-25", "Math workshop", Category::from_primary("school"));
